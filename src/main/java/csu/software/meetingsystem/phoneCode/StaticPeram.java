...
public class StaticPeram {
    ...
    // 替换成你的AK (产品密)
    final static String accessKeyId = "LTAI4GF5R1BpNj4tdFGEFFiy";// 你的accessKeyId,填你自己的 上文配置所得  自行配置
    final static String accessKeySecret = "fGzjkRIhOhBWJWAcxdenffEeeNPIhl";// 你的accessKeySecret,填你自己的 上文配置所得 自行配置
    // 必填:短信签名-可在短信控制台中找到
    final static String SignName = "学生购物商城";// 阿里云配置你自己的短信签名填入
    // 必填:短信模板-可在短信控制台中找到
    final static String TemplateCode = "SMS_195576368"; // 阿里云配置你自己的短信模板填入
